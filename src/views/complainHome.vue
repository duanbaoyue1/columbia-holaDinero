<template>
  <div class="complain-home content-area">
    ...
    <div class="warm-tips">
      ...
      <div>
        The system will send the complaint case to the selected complaint
        agency, and the agency will process it within 7 days, please wait
        patiently.
      </div>
    </div>

    <div class="actions">
      <a @click="goComplainRecord" :class="{ 'show-red': showRedBot }"
        >Complaint record</a
      >
    </div>
