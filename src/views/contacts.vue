<template>
  <div class="information content-area">
    ...
    <div class="edit-area-wrapper" v-for="(item, index) in familyContacts" :key="index">
      <div class="edit-area-header">Emergency Contact {{ index + 1 }}</div>
      <div class="edit-area">
        <div class="line-item">
          <label>Family Member</label>
          <select-item :items="ALL_ATTRS.RELATION_SHIPS" title="Family Member" :itemAttrs="index" @choose="chooseRelation" />
        </div>
    ...
    <div class="edit-area-wrapper" v-for="(item, index) in friendContacts" :key="index">
